...
$PolicyConfig      = @{
  ...
  ManagedIdentityResourceId = '/subscriptions/xxx/resourceGroups/rg-far-machine-configuration-eastus/providers/Microsoft.ManagedIdentity/userAssignedIdentities/id-policy-download-eastus'
}
