...
resource vnm 'Microsoft.Network/networkManagers@2025-07-01' = {
  name: 'vnm-hub-${location}-001'
  location: location
  properties: {
...
resource vnmNetworkGroupSpokesDynamic 'Microsoft.Network/networkManagers/networkGroups@2025-07-01' = {
...
resource vnmConnectivityConfigurationHubAndSpoke 'Microsoft.Network/networkManagers/connectivityConfigurations@2025-07-01' = if (connectivityTopology == 'hubAndSpoke') {
...
resource vnmSecurityConfig 'Microsoft.Network/networkManagers/securityAdminConfigurations@2025-07-01' = {
...
resource vnmRulesCollection 'Microsoft.Network/networkManagers/securityAdminConfigurations/ruleCollections@2025-07-01' = {
...
resource DENY_INTERNET_HTTP_HTTPS 'Microsoft.Network/networkManagers/securityAdminConfigurations/ruleCollections/rules@2025-07-01' = {
